...
def check_input():
	...
	parser.add_argument('inputDirforward', type=str, help='path to forward input')
	parser.add_argument('inputDirbackward', type=str, help='path to backward input')
	parser.add_argument('OptimInput', type=str, help='filepath of optim input')
	args = parser.parse_args()

	OptimIn = minidom.parse(args.OptimInput);
	forwardIn = minidom.parse(args.inputDirforward);
	backwardIn = minidom.parse(args.inputDirbackward);
