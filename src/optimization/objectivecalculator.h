 ...
 * see, e.g.,  Bartsch, J., Borzì, A., Fanelli, F. et al. A theoretical
 * investigation of Brockett’s ensemble optimal control problems. Calc. Var. 58,
 * 162 (2019). https://doi.org/10.1007/s00526-019-1604-2
 */
class ObjectiveCalculator : public AbstractController {
public:
  ObjectiveCalculator(std::shared_ptr<MOTIONS::InputData> &input_data);
