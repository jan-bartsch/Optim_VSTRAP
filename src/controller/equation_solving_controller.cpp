...
arma::mat equation_solving_controller::D1X1_second_order()
{
    comparator comp = comparator();
...
arma::mat equation_solving_controller::D1X2_second_order()
{
    comparator comp = comparator();
...
arma::mat equation_solving_controller::D1X3_second_order()
{
    comparator comp = comparator();
