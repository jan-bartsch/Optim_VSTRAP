...
int OutputControlUpdate::WritecontrolXml(arma::mat control) {
  ...
  std::string path_to_shared_files = MOTIONS::InputData::path_to_shared_files;
  std::string control_field_cells_namme =
      MOTIONS::InputData::control_field_cells_name;
...
int OutputControlUpdate::InterpolateControl() {
  std::string path_to_shared_files = MOTIONS::InputData::path_to_shared_files;
  std::string directory_toolset = MOTIONS::InputData::directory_toolset;
  std::string domain_mesh = MOTIONS::InputData::domain_mesh;

  int magnetic_force = MOTIONS::InputData::magnetic_force;
  int electric_force = MOTIONS::InputData::electric_force;
  ...
  std::string bgf_control = MOTIONS::InputData::bgf_control;
