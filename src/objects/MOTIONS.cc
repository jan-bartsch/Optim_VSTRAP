...
MOTIONS::InputData
InitializeMotions::Load_MOTIONS(DataProvider &data_provider_opt) {
...
InputData InitializeMotions::LoadInputData(DataProvider &data_provider_opt) {
  ...
  input_data.simulating_plasma =
      std::stoi(optimizationParameters.at("simulating_plasma"));
  ...
  input_data.adjoint_s_x = std::stod(optimizationParameters.at("adjoint_s_x"));
  input_data.adjoint_s_y = std::stod(optimizationParameters.at("adjoint_s_y"));
  input_data.adjoint_s_z = std::stod(optimizationParameters.at("adjoint_s_z"));
  input_data.adjoint_vx = std::stod(optimizationParameters.at("adjoint_vx"));
  input_data.adjoint_vy = std::stod(optimizationParameters.at("adjoint_vy"));
  input_data.adjoint_vz = std::stod(optimizationParameters.at("adjoint_vz"));
  ...
  input_data.optimization_iteration_max =
      MOTIONS::InitializeMotions::stringToUnsigendInt(
          optimizationParameters.at("optimizationIteration_max_gp"));
  ...
  input_data.number_cells_position =
      MOTIONS::InitializeMotions::stringToUnsigendInt(
          optimizationParameters.at("number_cells_position"));
  ...
  input_data.dimension_control =
      MOTIONS::InitializeMotions::stringToUnsigendInt(
          optimizationParameters.at("dimensionOfControl_gp"));
  input_data.end_control_gp = MOTIONS::InitializeMotions::stringToUnsigendInt(
      optimizationParameters.at("end_control_gp"));
  input_data.start_control_gp = MOTIONS::InitializeMotions::stringToUnsigendInt(
      optimizationParameters.at("start_control_gp"));

  input_data.dt_gp = std::stod(optimizationParameters.at("dt_gp"));
  input_data.dt_VSTRAP = std::stod(optimizationParameters.at("dt_VSTRAP"));
  input_data.ntimesteps_gp = MOTIONS::InitializeMotions::stringToUnsigendInt(
      optimizationParameters.at("ntimesteps_gp"));
  input_data.plasma_state_output_interval =
      std::stoi(optimizationParameters.at("plasma_state_output_interval"));
  input_data.ntimesteps_gp_VSTRAP =
      MOTIONS::InitializeMotions::stringToUnsigendInt(
          optimizationParameters.at("ntimesteps_gp_VSTRAP")); // ntimesteps_gp*plasma_state_output_interval
                                                              // -->

  input_data.dv_gp = std::stod(optimizationParameters.at("dv_gp"));
  input_data.vcell_gp = MOTIONS::InitializeMotions::stringToUnsigendInt(
      optimizationParameters.at("vcell_gp"));
  ...
  input_data.fabs_tol_gp = std::stod(optimizationParameters.at("fabs_tol_gp"));
  ...
  input_data.creation_adjoint_partcles = paths.at("creation_adjoint_partcles");
  input_data.bgf_control = paths.at("bgf_control");
  input_data.control_field_cells_name = paths.at("control_field_cells_name");
  ...
  input_data.desired_trajectory = subroutines.at("desired_trajectory");
  input_data.objective_calculation = subroutines.at("objective_calculation");
...
uint InitializeMotions::stringToUnsigendInt(std::string string) {
  ...
  if (integer >= 0) {
    ...
    throw std::invalid_argument(
        "Invalid argument for converting string to uint");
  }
}
