...
/**
 * @brief The particle class defines a particle using its position, velocity and
 * weight
 */
class Particle {
...
public:
  ...
  Particle(double px_, double py_, double pz_, double vx_, double vy_,
           double vz_);
  Particle(double px_, double py_, double pz_, double vx_, double vy_,
           double vz_, int cell_id_);
  ...
  /**
   * @brief getVelocityMagnitudeParticle calculates speed of particles using
   * Euclidean Norm
   *
   * @return
   */
