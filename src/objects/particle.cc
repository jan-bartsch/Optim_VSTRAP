...
Particle::Particle(double px, double py, double pz, double vx, double vy,
                   double vz) {
  Particle::setPx(px);
  Particle::setPy(py);
  Particle::setPz(pz);
...
std::string Particle::toString() {
  return std::to_string(this->getPx()) + " " + std::to_string(this->getPy()) +
         " " + std::to_string(this->getPz()) + " " +
         std::to_string(this->getVx()) + " " + std::to_string(this->getVy()) +
         " " + std::to_string(this->getVz());
}
