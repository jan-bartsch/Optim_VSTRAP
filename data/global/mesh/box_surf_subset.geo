...
Point(8) = {-boxSize/2, boxSize/2, boxSize/2, gridSize};
	//Point(9) = {-50, 0, -25, gridSize};
	//Point(10) = {-50, 25, -25, gridSize};
	//Point(11) = {-50, 25, 25, gridSize};
	//Point(12) = {-50, 0, 25, gridSize};
	Point(9) = {-50, -25, 20, gridSize};
	Point(10) = {-50, 25, 20, gridSize};
	Point(11) = {-50, 25, 40, gridSize};
	Point(12) = {-50, -25, 40, gridSize};
