...
TEST(io, readParticlesLengthError) {
    ...
    try {
        std::vector<particle> particlesInput = inputController.readParticleVector("/home/jan/Promotion_linuxPC/Optim_VSTRAP/test/data/test_particle_reader_wrong.csv",",");
...
TEST(io, readParticleCellId) {
    ...
    std::vector<particle> particlesInput = inputController.readParticleVector("/home/jan/Promotion_linuxPC/Optim_VSTRAP/test/data/test_particle_reader.csv",",");
