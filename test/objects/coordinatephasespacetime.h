...
TEST(coordinates,constructor) {
    ...
    CoordinatePhaseSpaceTime coordinate = CoordinatePhaseSpaceTime(cell_id, vx, vy, vz, time);
...
TEST(coordinates,equals){
    ...
    CoordinatePhaseSpaceTime coordinate = CoordinatePhaseSpaceTime(cell_id, vx, vy, vz, time);
    CoordinatePhaseSpaceTime coordinate2 = CoordinatePhaseSpaceTime(cell_id, vx, vy, vz, time);
...
TEST(coordinates,difference) {
    ...
    CoordinatePhaseSpaceTime c1 = CoordinatePhaseSpaceTime(cell1,vx1,vy1,vz1,time1);
    CoordinatePhaseSpaceTime c2 = CoordinatePhaseSpaceTime(cell2,vx2,vy2,vz2,time2);
