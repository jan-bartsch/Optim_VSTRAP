...
TEST(stepdirection,noSuchMethod) {
    ...
    int stepsize_flag = size_contr.CalculateStepsize(gradient,J0,control,stepdirection,Input_particles,stepsize0);
...
TEST(stepdirection,gradientDescentNoThrow) {
    ...
    int return_flag = size_contr.CalculateStepsize(gradient,J0,control,stepdirection,Input_particles,stepsize0);
